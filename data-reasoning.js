const reasoningData = [
  {
    ...
    keyPoints: [
      "1. Letter Shifting (અક્ષર શિફ્ટિંગ): દરેક અક્ષરમાં સમાન વધારો કે ઘટાડો (+1, -2, +3). દા.ત. CAT ➔ DBU (+1 શિફ્ટિંગ).",
      "2. Opposite Letter Coding (વિરોધી અક્ષર): આપેલા અક્ષરને વિરોધી અક્ષરથી બદલવો (A➔Z, B➔Y, C➔X). સરવાળો = 27.",
      "3. Number Coding (અંક કોડિંગ): અક્ષરોના સ્થાન ક્રમનો સરવાળો. દા.ત. BOY = 2 + 15 + 25 = 42.",
      "4. Symbol Coding (પ્રતીક કોડિંગ): અક્ષરોને #, $, @, % પ્રતીકોથી દર્શાવવા. દા.ત. READ ➔ %#@$",
      "5. Condition Based Coding (શરતી કોડિંગ): જો સ્વર (Vowel) હોય તો +2, જો વ્યંજન (Consonant) હોય તો -1 કરવો.",
      "6. Word Replacement (શબ્દ બદલાવ): જો 'લાલ' ને 'લીલો' અને 'લીલા' ને 'પીળો' કહેવાય, તો ઘાસનો રંગ ➔ 'પીળો' થાય.",
      "7. Cross Pattern (ક્રોસ ગોઠવણી): અક્ષરોને સામસામી ક્રોસ દિશામાં ગોઠવી કોડિંગ. દા.ત. BEAT ➔ EBTA.",
      "8. EJOTY શોર્ટકટ: 5, 10, 15, 20, 25 સ્થાન ક્રમાંકો તુરંત ગણવા (E=5, J=10, O=15, T=20, Y=25).",
      "9. CFILORUX શોર્ટકટ: 3 ના ઘડિયાળ મુજબ અક્ષરો (C=3, F=6, I=9, L=12, O=15, R=18, U=21, X=24).",
      "10. અક્ષરોના ક્રમનો સરવાળો: BOY = 2+15+25 = 42 અને CAT = 3+1+20 = 24."
    ],
    questions: [
      {
        question: "કોઈ ચોક્કસ સંકેતમાં 'BOY' ને 42 લખાય છે (2+15+25), તો તે જ સંકેતમાં 'GIRL' નો કોડ શું થશે? (G=7, I=9, R=18, L=12)",
        options: ["46", "48", "44", "50"],
        correct: 0,
        explanation: "ગણતરી: G(7) + I(9) + R(18) + L(12) = 46. સાચો ઉત્તર 46 થાય."
      },
      {
        question: "જો 'CAT' નો કોડ 'DBU' (+1 શિફ્ટિંગ) હોય, તો 'DOG' નો કોડ શું થશે?",
        options: ["EPH", "FQI", "EOF", "DPH"],
        correct: 0,
        explanation: "નિયમ (+1 Letter Shifting): D+1=E, O+1=P, G+1=H ➔ EPH."
      },
      {
        question: "જો 'લાલ' ને 'પીળો', 'પીળા' ને 'લીલો', અને 'લીલા' ને 'વાદળી' કહેવાય, તો પાંદડાનો રંગ કયો કહેવાશે?",
        options: ["લીલો", "વાદળી", "પીળો", "લાલ"],
        correct: 1,
        explanation: "કુદરતી રીતે પાંદડાનો રંગ લીલો હોય છે, પરંતુ શરત મુજબ 'લીલા' ને 'વાદળી' કહેવાય છે. તેથી ઉત્તર વાદળી થશે."
      },
      {
        question: "EJOTY શોર્ટકટમાં 'T' અક્ષરનો સ્થાન ક્રમાંક કયો છે?",
        options: ["15", "18", "20", "25"],
        correct: 2,
        explanation: "EJOTY શોર્ટકટ મુજબ: E=5, J=10, O=15, T=20, Y=25."
      },
      {
        question: "Opposite Letter Coding ની રીતમાં 'A' ની સામે કયો અક્ષર આવે અને સરવાળો કેટલો થાય?",
        options: ["Z અને સરવાળો 27", "Y અને સરવાળો 26", "X અને સરવાળો 25", "W અને સરવાળો 27"],
        correct: 0,
        explanation: "A નું સ્થાન 1 અને Z નું સ્થાન 26 ➔ 1 + 26 = 27 (AZad)."
      }
    ],
    mnemonics: "EJOTY (5-10-15-20-25), CFILORUX (3-6-9-12-15-18-21-24), વિરોધી અક્ષરો: AZad, BoY, CraX, DeW, EVening, FUr, G.T.Road, HighSchool, IndianRailways, JungleQueen, KanPur, LOve, MaN"
  },
  {
